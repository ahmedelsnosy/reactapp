...
export default function DetailsSimilar() {
            ...
            <div className="row">
                {similar.map((movie, index) =>
                    <div className="col-md-3" key={index}>
                        <Link className='nav-link' to={`/details/${movie.id}/${params.mediaType}`}>
                            <div className='position-relative'>
                                ...
                                <h2>{movie.title}</ h2>
                                <h2>{movie.name}</ h2>
                                {movie.vote_average ? <div className="position-absolute end-0 text-white top-0 bg-warning p-2">
